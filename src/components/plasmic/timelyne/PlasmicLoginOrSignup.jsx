...
import * as sty from "./PlasmicLoginOrSignup.module.css" // plasmic-import: -_EzUKxm9F/css
...
export const PlasmicLoginOrSignup__VariantProps = new Array()

export const PlasmicLoginOrSignup__ArgProps = new Array()

function PlasmicLoginOrSignup__RenderFunc(props) {
...
const PlasmicDescendants = {
  ...
  columns: ["columns", "column", "container4", "h2", "img", "link", "text"],
  column: ["column", "container4", "h2", "img", "link", "text"],
  container4: ["container4", "h2", "img", "link", "text"],
  h2: ["h2"],
  img: ["img"],
  link: ["link", "text"],
  text: ["text"],
...
function makeNodeComponent(nodeName) {
  const func = function (props) {
    const { variants, args, overrides } = deriveRenderOpts(props, {
      ...
      internalArgPropNames: PlasmicLoginOrSignup__ArgProps,
      internalVariantPropNames: PlasmicLoginOrSignup__VariantProps,
    })

    return PlasmicLoginOrSignup__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName,
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicLoginOrSignup"
  } else {
    func.displayName = `PlasmicLoginOrSignup.${nodeName}`
  }
  return func
}

export const PlasmicLoginOrSignup = Object.assign(
  // Top-level PlasmicLoginOrSignup renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicLoginOrSignup
    internalVariantProps: PlasmicLoginOrSignup__VariantProps,
    internalArgProps: PlasmicLoginOrSignup__ArgProps,
  }
)

export default PlasmicLoginOrSignup
/* prettier-ignore-end */
